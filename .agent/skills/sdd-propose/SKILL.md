...
name: sdd-propose
description: >
  BanterBot Sports wrapper for the global sdd-propose skill.
...
2. Read `~/.claude/skills/sdd-propose/SKILL.md` — full skill instructions
...
- PRD already exists at `PRD.md` — treat it as the master proposal reference
